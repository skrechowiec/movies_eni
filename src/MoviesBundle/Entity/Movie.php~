...
class Movie
{
     ...
     * Add critique
     *
     * @param \MoviesBundle\Entity\Review $critique
     *
     * @return Movie
     */
    public function addCritique(\MoviesBundle\Entity\Review $critique)
    {
     ...
     * @param \MoviesBundle\Entity\Review $critique
     */
    public function removeCritique(\MoviesBundle\Entity\Review $critique)
    {
